...
Die bereinigte Version des Datensatzes wurde als `production_analysis_clean.csv` exportiert und für die weiteren Analysen in SQL sowie Power BI verwendet.
