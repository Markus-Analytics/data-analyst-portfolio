...
print("\n=== Echte Gesamtkosten ===")
print(echte_gesamtkosten_maschine.sort_values(ascending=False).round(2))
...
# Fazit
# ======================
# M1: Höchste Gesamtkosten durch hohe Produktionsmenge
# M2: Höchster finanzieller Schaden durch Stillstand
# M3: Höchste Ausschussquote und höchste Durchschnittskosten - ineffizienteste Maschine 